...
run-local:
	@echo 'PEBBLE=${PWD}/examples/nginx'
	@PEBBLE=${PWD}/examples/nginx ${BIN_DIR}/pebble run

docker-dev:
	@echo "Building pebble docker image 'latest'"
	@docker build -t latest . -f Dockerfile.dev
